...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    product_sets: Schema.Attribute.Relation<
      'manyToMany',
      'api::product-set.product-set'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDebugDebug extends Struct.SingleTypeSchema {
  collectionName: 'debugs';
  info: {
    description: 'Debug utilities for environment variables';
    displayName: 'Debug';
    pluralName: 'debugs';
    singularName: 'debug';
  };
...
export interface ApiProductSetProductSet extends Struct.CollectionTypeSchema {
  collectionName: 'product_sets';
  info: {
    displayName: 'Product set';
    pluralName: 'product-sets';
    singularName: 'product-set';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductVariantProductVariant
  ...
  attributes: {
    ...
    material_variant: Schema.Attribute.String;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    age_range: Schema.Attribute.String;
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    applies_tp: Schema.Attribute.Enumeration<
    ...
    discount_type: Schema.Attribute.Enumeration<
      ['percentaje', 'fixed_amount']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'percentaje'>;
    discount_value: Schema.Attribute.Integer & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    promo_code: Schema.Attribute.String & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::product-set.product-set': ApiProductSetProductSet;
